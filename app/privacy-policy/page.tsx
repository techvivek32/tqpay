          ...
          <div className="space-y-8">
            ...
            <Card className="hover-lift border-2 border-primary/20 bg-card/80 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-muted/50 p-4 rounded-lg">
                  <p className="font-semibold mb-2">TQ Technologies Private Limited</p>
                  <p className="text-muted-foreground">Email: privacy@tqpay.com</p>
                  <p className="text-muted-foreground">Address: Rajkot, Gujarat, India</p>
                </div>
            ...
            <div className="text-center py-8">
              <p className="text-muted-foreground mb-4">
                This privacy policy is effective as of December 2024 and may be updated from time to time.
              </p>
              <Link href="/">
