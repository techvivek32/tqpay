        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                PIXELROOT TECHNOLOGIES PRIVATE LIMITED is a Private incorporated entity classified as Company limited by
                Shares and is located in Rajkot, Gujarat, India. Its authorized share capital is Rs. 100000 and the
