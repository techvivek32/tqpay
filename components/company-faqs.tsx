        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed mb-8">
              <p className="font-semibold text-foreground">What is PIXELROOT TECHNOLOGIES PRIVATE LIMITED?</p>
              <p>
                We are extremely driven professionals working with a vision to deliver our best to enrich the customer
                experience. In fact, PIXELROOT TECHNOLOGIES PRIVATE LIMITED works as an multi utility and 24*7 recharge
